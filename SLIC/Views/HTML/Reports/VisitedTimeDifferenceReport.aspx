<%@ Page Title="" Language="C#" MasterPageFile="~/Views/HTML/Shared/Site.Master"
    Inherits="System.Web.Mvc.ViewPage<com.IronOne.SLIC2.Models.Reports.VisitedTimeDifferenceModel>" %>

<%@ Import Namespace="com.IronOne.SLIC2.HandlerClasses" %>
<%@ Import Namespace="com.IronOne.SLIC2.Lang" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Visited Time Difference Report
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="HeaderContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function LoadResult() {
            ...
            var actionUrl2 = '<%: Html.ActionLink(" ", "VisitedTimeDifferenceReportAjaxHandler", "Report", null, null) %>';
        ...
        function GetPrintPreview() {
            ...
            if (isToBePrinted) {
                var actionUrl = '<%: Html.ActionLink(" ", "VisitedTimeDifferenceReportPrintPreview", "Report", null, null) %>';
                actionUrl = actionUrl.replace('<a href="', '');
                actionUrl = actionUrl.replace('"> </a>', '');
                actionUrl = actionUrl.replace('amp;', '');
                actionUrl = actionUrl.replace('amp;', '');
        ...
        function GetExcelReport() {
            ...
            var actionUrl = '<%: Html.ActionLink(" ", "VisitedTimeDifferenceReportToExcel", "Report", null, null) %>';
            actionUrl = actionUrl.replace('<a href="', '');
            actionUrl = actionUrl.replace('"> </a>', '');
            actionUrl = actionUrl.replace('amp;', '');
            actionUrl = actionUrl.replace('amp;', '');
            ...
            window.location = actionUrl + "?DateFrom=" + DateFrom + "&DateTo=" + DateTo + "&Name=" + Name + "&RegionName=" + RegionName;
        }   
        ...
        <div class="widget highlight widget-accordion widget-table">
            <div class="widget-header">
                <h3>
                    ...
                    <%: Resources.info_gen_VisitedTimeDifferenceReport%>
                </h3>
            </div>
                    ...
                    <div class="accordion-group audit-log">
                        ...
                        <div id="collapseFour" class="accordion-body in collapse">
                            <div class="accordion-inner">
                                <% using (Html.BeginForm("VisitedTimeDifferenceReport", "Report", null, FormMethod.Post, new { @id = "contact-form", @class = "form-actions-full", @novalidate = "novalidate" }))
                                   { %>
