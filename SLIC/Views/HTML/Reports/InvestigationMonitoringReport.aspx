                            ...
                            <div class="accordion-inner">
                                ...
                                <fieldset class="form-horizontal control-group-width-full" style="border-bottom: 1px dotted #CCC;">
                                    <div class="control-group-width-half">
                                        <div class="control-group">
                                            <label class="control-label" for="name">
                                                <%: Resources.info_gen_acrFrom%></label>
                                            <div class="controls">
                                                <%: Html.TextBoxFor(model => model.ACRFrom, new { @class = "input-large" })%></div>
                                        </div>
                                    </div>
                                    <div class="control-group-width-half">
                                        <div class="control-group">
                                            <label class="control-label" for="name">
                                                <%: Resources.info_gen_acrTo%></label>
                                            <div class="controls">
                                                <%: Html.TextBoxFor(model => model.ACRTo, new { @class = "input-large" })%></div>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset class="form-horizontal control-group-width-full" style="border-bottom: 1px dotted #CCC;">
                                ...
                                <fieldset class="form-horizontal control-group-width-full" style="border-bottom: 1px dotted #CCC;">
                                    <div class="control-group-width-half">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <%: Html.DropDownListFor(model => model.RelationshipId,(IEnumerable<SelectListItem>)(ViewData["RelationshipType"]))%></div>
                                        </div>
                                    </div>
                                    <div class="control-group-width-half">
                                        <div class="control-group">
                                            <label class="control-label" for="name">
                                                <%: Resources.info_gen_furtherReview%></label>
                                            <div class="controls">
                                                <%: Html.DropDownListFor(model => model.FurtherReview, (IEnumerable<SelectListItem>)(ViewData["FutherReview"]))%></div>
                                        </div>
                                    </div>
                                </fieldset>
