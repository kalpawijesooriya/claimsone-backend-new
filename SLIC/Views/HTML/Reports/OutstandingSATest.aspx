...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                            ...
                            <div class="accordion-inner">
                                ...
                                <fieldset class="form-horizontal form-actions-full">
                                    <div class="form-actions">
                                        <input type="button" class="btn btn-primary" id="search"  value="<%: Resources.info_gen_search%>" />
  ...
  <!--  <script src="../../../Content/dataTables/jquery-3.3.1.js" type="text/javascript"></script>
    <script src="../../../Content/dataTables/jquery.dataTables.min.js" type="text/javascript"></script>
    <script src="../../../Content/dataTables/dataTables.buttons.min.js" type="text/javascript"></script>
    <script src="../../../Content/dataTables/buttons.flash.min.js" type="text/javascript"></script>
    <script src="../../../Content/dataTables/jszip.min.js" type="text/javascript"></script>
    <script src="../../../Content/dataTables/pdfmake.min.js" type="text/javascript"></script>
    <script src="../../../Content/dataTables/vfs_fonts.js" type="text/javascript"></script>
    <script src="../../../Content/dataTables/buttons.html5.min.js" type="text/javascript"></script>
    <script src="../../../Content/dataTables/buttons.print.min.js" type="text/javascript"></script> -->
    <script>
        ...
        $("#search").click(function() {
            ...
            var table = $('#PerformanceTableView').DataTable({
