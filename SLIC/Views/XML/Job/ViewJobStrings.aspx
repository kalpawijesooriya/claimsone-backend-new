       ...
       { %>
        <Job>
            <FieldList>
                ...
                <LicenceType> <%: Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.LicenseType), Model.License_TypeId)%></LicenceType>
                 <!--  Other=0, MTA32 =1, MTA39=2,CMT49=3, INTLIC=4-->
                <LicenseNewOld>
                    <IsNew><%:Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.Confirmation), Convert.ToInt32(Model.License_IsNew))%></IsNew>
                    <!--  Old=0,New =1-->
                ...
                <DriverCompetence><%: Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.Confirmation), Model.DriverCompetence)%></DriverCompetence>
                <!--No-0,Yes-1-->
                <VehicleClass>
           ...
           <%--     <%if (Model.VehicleClassIds != null && Model.VehicleClassIds.Count > 0)
             ...
             <%--   <%=HttpUtility.HtmlEncode(new HtmlString(Model.DamagedItems))%>--%>
                ...
                <TyreCondition>
                    <!--Fair-1,Good-2,Bad-3 -->
                    <FR><%: Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.TyreConditon), Model.Tyre_FR_Status)%></FR>
                    <FL><%: Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.TyreConditon), Model.Tyre_FL_Status)%></FL>
                    <RRL><%: Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.TyreConditon), Model.Tyre_RRL_Status)%></RRL>
                    <RLR><%: Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.TyreConditon), Model.Tyre_RLR_Status)%></RLR>
                    <RLL><%:Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.TyreConditon), Model.Tyre_RLL_Status)%></RLL>
                    <RRR><%: Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.TyreConditon), Model.Tyre_RRR_Status)%></RRR>
                </TyreCondition>
                <TyreContributory><%:Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.Confirmation), Convert.ToInt32(Model.Tyre_IsContributory))%></TyreContributory>
                <!--No-0,Yes-1-->
                ...
                <OverLoaded><%:Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.Confirmation), Convert.ToInt32(Model.IsOverLoaded))%>  </OverLoaded>
                <!--No-0,Yes-1-->
                <OverWeightContributory><%:Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.Confirmation), Convert.ToInt32(Model.Is_OL_Contributory))%></OverWeightContributory>
                <!--No-0,Yes-1-->
                ...
                <JourneyPurpose><%:Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.JourneyPurpose), Model.Journey_PurposeId)%></JourneyPurpose>
                <!-- Other=0, Work=1,Trip=2-->
                <DriverRelationship><%:Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.RelationshipType), Model.DriverRelationship)%></DriverRelationship>
                ...
                <CSRConsistency><%:Enum.GetName(typeof(com.IronOne.SLIC2.Models.Enums.CSR_Consistency), Model.CSR_Consistency)%></CSRConsistency>
                <CSRUserName><%: Model.CSR_UserName%></CSRUserName>
                <FurtherReview><%:Convert.ToInt32(Model.FurtherReview)%></FurtherReview>
                <!--UserName 0R UserId--> 
            </FieldList>          
        </Job>  
        <%
